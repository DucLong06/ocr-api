                ...
                lessLoaderOptions: {
                    lessOptions: {
                        modifyVars: {
                            ...
                            "@text-color": "#404446", //"fade(@black, 85%)",
                            // "@text-color-secondary": "fade(@black, 45%)",
                            // "@text-color-inverse": "@white",
                            // "@icon-color": "inherit",
                            // "@icon-color-hover": "fade(@black, 75%)",
                            "@heading-color": "#090A0A", //"fade(@black, 85%)",
                            ...
                            // Border color
                            "@border-color-base": "#E3E5E5", //"hsv(0, 0, 85%)", // base border outline a component
                            ...
                            "@box-shadow-base": "-8px 8px 16px rgba(67, 86, 100, 0.0780977)", //"@shadow-2",
                            ...
                            "@table-padding-horizontal-md": "(@table-padding-horizontal * 3 / 4)",
